                ...
                Center(
                  child: Column(
                    children: [ 
                      ...
                      GestureDetector(
                        onDoubleTap: () {
                          // Cambiar foto (implementar lógica)
                          setState(() {
                            _fotoUrl = 'https://randomuser.me/api/portraits/lego/${DateTime.now().millisecondsSinceEpoch % 10}.jpg';
                          });
                        },
                        child: Image.network(
                                  _fotoUrl,
                      ...
                      ElevatedButton(
                        onPressed: () {
                          setState(() {
                            final String generoSubRuta = (_sexo == 'M') ? 'men' : 'women';
                            _fotoUrl = 'https://randomuser.me/api/portraits/$generoSubRuta/${DateTime.now().millisecondsSinceEpoch % 100}.jpg';
                          });
                        },
  ...
  void _guardarCliente() {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      Navigator.pop(context, {
        'cliente': nuevo,
        'indice': _esEditable ? _indiceEditable : null,
      });
    }
  }
